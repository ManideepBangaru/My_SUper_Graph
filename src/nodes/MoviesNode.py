...
_config = read_yaml("prompts/movies_node.yaml")
...
async def MoviesAgent(state: MainGraphState, config: RunnableConfig):
    """
    Responds to movies/TV-related queries.
    All configuration is loaded from prompts/movies_node.yaml.
    """
    writer = get_stream_writer()
    writer({"Progress": "Movies agent initiated ..."})
